...
function Login() {
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center'>
            ...
            <Grid xs={6} style={{
                 backgroundImage: 'url(https://blog.elgscreen.com/wp-content/uploads/2016/08/teclado-do-notebook-750x410.png)' ,
                 backgroundRepeat: 'no-repeat', width: '100vh', minHeight: '100vh', backgroundPosition: 'center'
            }}>
